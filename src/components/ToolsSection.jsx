...
const ToolsSection = () => {
  ...
  // Referencias para el scroll horizontal del menú
  const sliderRef = useRef(null);
  const isDown = useRef(false);
  const startX = useRef(0);
  const scrollLeft = useRef(0);

  // Configuración de Grupos: Asocia las categorías internas con las pestañas visibles
  ...
  const filteredTools = useMemo(() => {
    if (activeCategory === 'Todas') {
      // Si es "Todas", mostramos todas ordenadas por popularidad
    ...
    return AI_TOOLS_DATA.filter(tool => {
        // Normalizamos la categoría para evitar errores de espacios
  ...
  // Manejadores de eventos para el scroll con arrastre (drag-to-scroll)
  ...
  return (
    <div className="relative py-12 px-4 md:px-6 z-10 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="sticky top-20 z-30 bg-[#334E68]/95 backdrop-blur-md py-4 -mx-4 px-4 md:mx-0 md:px-0 mb-8 border-b border-[#486581]/50">
          <div 
            ref={sliderRef}
